...
const STUDIO_TABS = ['context', 'build', 'test', 'harden'] as const;
...
export default async function AIStudioPage({
  ...
  // Whether a résumé has been uploaded (the Context Document tab needs one, or at
  // least a career source, to generate from; without it we show a friendly nudge).
